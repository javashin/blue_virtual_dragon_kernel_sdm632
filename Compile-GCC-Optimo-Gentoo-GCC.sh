...
cd ANYKERNEL/
rm 4.9.2*.zip
zip -r9 4.9.235-BvD-HyDrA_rV21+OCEAN-Thu-September-10-2020.zip * -x .git README.md *placeholder
cp 4.9.235-BvD-HyDrA_rV21+OCEAN-Thu-September-10-2020.zip /home/javashin/Desktop/
ls -lash 4.9.235-BvD-HyDrA_rV21+OCEAN-Thu-September-10-2020.zip ; pwd ; cd .. ; pwd
