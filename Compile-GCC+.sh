...
export KCFLAGS+="-march=armv8-a+fp+simd+crc+crypto -mcpu=cortex-a73.cortex-a53 -mtune=cortex-a73.cortex-a53 -fomit-frame-pointer -fno-math-errno -fno-trapping-math -fno-plt -fdevirtualize-at-ltrans -fno-common -fno-semantic-interposition -fipa-pta -fgraphite-identity -floop-nest-optimize"
export KBUILD_CFLAGS+="-march=armv8-a+fp+simd+crc+crypto -mcpu=cortex-a73.cortex-a53 -mtune=cortex-a73.cortex-a53 -fomit-frame-pointer -fno-math-errno -fno-trapping-math -fno-plt -fdevirtualize-at-ltrans -fno-common -fno-semantic-interposition -fipa-pta -fgraphite-identity -floop-nest-optimize"

PATH="${PATH}" make -j3 O=/OUT ARCH=arm64 SUBARCH=arm CC=aarch64-suse-linux-gcc LD=aarch64-suse-linux-ld.bfd DTC_EXT=dtc CONFIG_BUILD_ARM64_DT_OVERLAY=y KCFLAGS+="-O3 --param=max-inline-insns-auto=1000 -fno-stack-protector -march=armv8-a+fp+simd+crc+crypto -mcpu=cortex-a73.cortex-a53 -mtune=cortex-a73.cortex-a53" CROSS_COMPILE_ARM32=arm-suse-linux-gnueabi- CROSS_COMPILE=aarch64-suse-linux- CONFIG_NO_ERROR_ON_MISMATCH=y CONFIG_INPUT_FOCALTECH_0FLASH_MMI_IC_NAME=ft8719 CONFIG_INPUT_HIMAX_V2_MMI_IC_NAME=hx83102 CONFIG_INPUT_HIMAX_V2_MMI_IC_NAME=hx83112 SELINUX_DEFCONFIG=selinux_defconfig CONFIG_RD_ZSTD=y CONFIG_CRYPTO_STREEBOG=y CONFIG_CRYPTO_ZSTD=y CONFIG_XXHASH=y CONFIG_DECOMPRESS_ZSTD=y CONFIG_ZSTD_COMPRESS=y CONFIG_ZSTD_DECOMPRESS=y FB_MSM_MDSS_KCAL_CTRL=y ocean_gcc_defconfig
