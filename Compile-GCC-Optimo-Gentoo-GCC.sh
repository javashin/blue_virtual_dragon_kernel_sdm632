...
cd ANYKERNEL/
rm 4.9.2*.zip
zip -r9 4.9.235-jsX-BvD_rV4+OCEAN-Fri-September-11-2020.zip * -x .git README.md *placeholder
cp 4.9.235-jsX-BvD_rV4+OCEAN-Fri-September-11-2020.zip /home/javashin/Desktop/
ls -lash 4.9.235-jsX-BvD_rV4+OCEAN-Fri-September-11-2020.zip ; pwd ; cd .. ; pwd
