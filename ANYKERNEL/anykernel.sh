...
# begin properties
properties() { '
kernel.string=-#- JavaShin-X OCEAN-KERNEL-4.9.231-Blue-Virtual-Dragon MSM-4.9 -r27 For Moto G7 Power Ocean -#-
do.devicecheck=1
do.modules=0
do.systemless=1
do.cleanup=1
...
ui_print "KVer: 4.9.231-Blue-Virtual-Dragon_r2 jsX-CustoKernal SMP PREEMPT aarch64"
ui_print "Wed 31 July 2020"
